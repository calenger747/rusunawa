...
<html lang="en">
  ...
  <style type="text/css">
    body{
      background: url('images/aweb.jpg');
    } 
...
<body src="images/background_web.jpg" width=1300 height=300 onload="updateDB();">
<?php 
//KONEKSI DATABASE
...
$sql = mysqli_query($connection, "SELECT * FROM tbl_unit WHERE id_unit='$kode_unit'");
...
<h1><center style="color: white; font-size: 60px;">Booking Request</center></h1>
  ...
  <div class="form-group col-sm-7">
     <label style="color: white; font-size: 20px;">Nama Kartu Keluarga</label>
     <input style="opacity: 0.8;" type="text" name="nama" placeholder="Nama Kartu Keluarga" class="form-control" required="">
  </div>
  <div class="form-group col-sm-7">
     <label style="color: white; font-size: 20px;">Unit DiBooking</label>
     <input style="opacity: 0.8;" type="text" name="unit" value="<?= $id_unit ?>" readonly placeholder="No Unit" class="form-control">
  </div>
  <div class="form-group col-sm-7">
  ...
  <div class="form-group col-sm-7">
     ...
     <textarea style="opacity: 0.8;" name="alamat" placeholder="Alamat Sesuai Ktp" class="form-control" required=""></textarea>
  </div>
  <div class="form-group col-sm-7">
     ...
     <p style="color: white; font-size: 20px;">NOTE :
