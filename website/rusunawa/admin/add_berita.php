...
include 'connection.php';
  $carikode = mysqli_query($conn, "SELECT max(kode_berita) FROM update_berita") or die (mysql_error());
  $datakode = mysqli_fetch_array($carikode);
    if ($datakode) {
      $nilaikode = substr($datakode[0],2);
      $kode_berita = (int) $nilaikode;
      $kode_berita = $kode_berita +1;
      $hasilkode = "BR" .str_pad($kode_berita, 3, "0", STR_PAD_LEFT);
    } else {
      $hasilkode = "BR001";
    }
?>
...
<div class="container">
<h1><center style=" font-size: 30px;">Form Tambah Berita Terkini</center></h1>
  <div class="form-group col-sm-3">
     <label style=" font-size: 20px;">Kode Berita</label>
     <input type="text" name="kode_berita" class="form-control" value="<?php echo $hasilkode; ?>" readonly>
  </div>
  <div class="form-group col-sm-7">
     <label style=" font-size: 20px;">Judul berita</label>
     <input type="text" name="judul_berita" placeholder="Judul Berita Terkini" class="form-control" required>
  </div>
  <div class="col-sm-3">
     <label style=" font-size: 20px;">Gambar Berita</label>
     <input type="file" name="gambar" id="gambar">
  </div><br/>
  <div class="form-group col-sm-7">
     <label style=" font-size: 20px;">Deskripsi berita</label>
     <textarea name="deskripsi" placeholder="Deskripsi Berita Terkini" class="form-control" required></textarea>
  </div>
