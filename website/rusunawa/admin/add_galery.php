...
<html lang="en">
  ...
  <head>
    ...
    <title>Update Galery Terkini</title>
    <!-- Bootstrap core CSS-->
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="#">Tower B</a>
            <a class="dropdown-item" href="#">Tower C</a>
...
include 'connection.php';
  $carikode = mysqli_query($conn, "SELECT max(kode) FROM update_galery")   or die (mysql_error());
...
<!-- DataTables Example -->
          <div class="card mb-3">
            ...
            <i class="fas fa-list"></i>
              Galery Kegiatan Rusunawa Depok  </div>



          <form  action="proses_galery.php" method="post" enctype="multipart/form-data">
<div class="container">
<h1><center style=" font-size: 30px;">Form Update Galery Terkini</center></h1>
  <div class="form-group col-sm-3">
     <label style=" font-size: 20px;">Kode Galery</label>
     <input type="text" name="kode" class="form-control" value="<?php echo $hasilkode; ?>" readonly>
  </div>
  <div class="col-sm-3">
     <label style=" font-size: 20px;">Galery Kegiatan Rusunawa</label>
