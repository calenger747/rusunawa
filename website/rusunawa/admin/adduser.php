...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand" href="index_super_admin.php">Rusunawa</a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item active">
          <a class="nav-link" href="index_super_admin.php">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="index_user_super.php">User</a>
...
mysql_select_db("rusunawa");
  $carikode = mysql_query("SELECT max(kode_user) FROM user")   or die (mysql_error());
  $datakode = mysql_fetch_array($carikode);
    if ($datakode) {
      $nilaikode = substr($datakode[0],2);
      $kode_user = (int) $nilaikode;
      $kode_user = $kode_user +1;
      $hasilkode = "US" .str_pad($kode_user, 3, "0", STR_PAD_LEFT);
    } else {
      $hasilkode = "US001";
    }
?>
...
<div class="container">
<h1><center style=" font-size: 30px;">Form Add User</center></h1>
  <div class="form-group col-sm-3">
     <label style=" font-size: 20px;">Kode User</label>
     <input type="text" name="kode_user" class="form-control" value="<?php echo $hasilkode; ?>" readonly>
  </div>
  <div class="form-group col-sm-3">
