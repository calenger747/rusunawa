...
if( !isset($_GET['id']) ){
    header('Location: form_update_tower_b.php');
}
...
$sql = "SELECT * FROM tower_b WHERE kode='$kode'";
...
<body>
    <form action="proses_update_tower_b.php" method="POST">
    <div class="container">
    <h2><center>Form Update Tower B</center></h2>
