...
if( !isset($_GET['id']) ){
    header('Location: form_update_tower_c.php');
}
...
$sql = "SELECT * FROM tower_c WHERE kode='$kode'";
...
<body>
    <form action="proses_update_tower_c.php" method="POST">
    <div class="container">
    <h2><center>Form Update Tower C</center></h2>
