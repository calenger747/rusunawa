...
include 'connection.php';
  $carikode = mysqli_query($conn, "SELECT max(kode) FROM tower_c")   or die (mysql_error());
  $datakode = mysqli_fetch_array($carikode);
    if ($datakode) {
      $nilaikode = substr($datakode[0],2);
      $kode = (int) $nilaikode;
      $kode = $kode +1;
      $hasilkode = "TC" .str_pad($kode, 3, "0", STR_PAD_LEFT);
    } else {
      $hasilkode = "TC001";
    }
?>
...
<!-- DataTables Example -->
          <div class="card mb-3">
            ...
            <i class="fas fa-list"></i>
              Unit C Rusunawa Depok  </div>



          <form  action="proses_tower_c.php" method="post">
<div class="container">
<h1><center style=" font-size: 30px;">Form Unit C Rusunawa </center></h1>
