...
if ($query) {
	$update = mysqli_query($conn, "UPDATE tower_b SET status = 'Booking' WHERE kode='$id_unit'");
	...
	location.href='/deluxe/deluxe/hasil_booking_b.php'</script>";
}else{
	echo "<script>alert('Gagal Booking! Silahkan Coba Lagi')
	location.href='/deluxe/deluxe/booking_tower_b.php'</script>";
}
