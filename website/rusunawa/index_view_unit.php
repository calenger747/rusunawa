      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="denaha.php">Tower A</a></span><span class="mr-2"><a href="denahb.php">Tower B</a></span>
	            <span class="mr-2"><a href="denahc.php">Tower C</a></span></p>
	            <h1 class="mb-4 bread">Tower A Rusunawa Depok</h1>
            </div>
          </div>
        </div>
      </div>
