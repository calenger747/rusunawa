    					...
    					while($row1 = mysqli_fetch_array($sql)){ ?>
		    				<div class="button">
		    					...
		    					<?php elseif ($row1['status'] == 'Booking'): ?>
		    						<button type="button" title="Sudah Terbooking" href="#" class="btn-warning o-hidden h-10"><center>
					              		<?php echo $row1['lantai'];?><?php echo $row1['no_unit'];?></center>
					                	<div class="card-body">
    				...
    				for ($o=1; $o <=2 ; $o++) { 
    					while($row1 = mysqli_fetch_array($sql)){ ?>
		    				<div class="button">
		    					...
		    					<?php elseif ($row1['status'] == 'Booking'): ?>
		    						<button type="button" titlt="Sudah Terbooking" href="#" class="btn-warning o-hidden h-10"><center>
					              		<?php echo $row1['lantai'];?><?php echo $row1['no_unit'];?></center>
					                	<div class="card-body">
