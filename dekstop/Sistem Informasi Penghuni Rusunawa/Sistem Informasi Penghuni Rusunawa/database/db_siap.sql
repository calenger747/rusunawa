...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2019 at 04:17 AM
...
(2, '123', 'a', '1', '1', '1', 'a', 'a', 'a', 'a', '1'),
(3, '111', 'a', '1', '1', '1', 'a', '1', 'a', '1', '1'),
(4, '888', 'a', '1', '1', '1', 'a', 'a', 'a', 'a', '11');
...
('111', 'a', '113', '2018-09-10'),
('123', 'a', '112', '2018-09-10'),
('3276102805140002', 'ari', '111', '2018-09-10'),
('888', 'kas', '114', '2018-09-10');
...
('111', '1899-12-31', '2018-09-10', '113', 'Januari 2019', '250000', 'BELUM BAYAR', '176'),
('123', '1899-12-31', '2018-09-10', '112', 'Januari 2019', '250000', 'BELUM BAYAR', '176'),
('18-08-29-10-10-07', '2018-08-29', '2019-02-10', '111', 'Januari 2019', '175000', 'BELUM BAYAR', '176'),
('888', '1899-12-31', '2018-09-10', '114', 'Januari 2019', '170000', 'BELUM BAYAR', '176'),
...
('TRIB0000529082018', '2018-08-29', '2019-01-10', '111', 'Desember 2018', '175000', 'LUNAS', '176');
...
(5, '3276102805140002', '8109', 'b', 'ANAK', 'LK', 'aa', '2010-11-19', 'ISLAM', 'YA', 'SD/Sederajat', 'Pelajar', 'BK', '-', 'Masih Hidup'),
(6, '3276102805140002', '657', 'aaa', 'ANAK', 'LK', 'aaa', '2010-07-15', 'ISLAM', 'YA', 'DIPLOMA', 's', 'BK', '-', 'Masih Hidup'),
(7, '123', '0', 'a', 'KK', 'LK', 'a', '1994-02-03', 'ISLAM', 'YA', 'SMP/Sederajat', 'a', 'K', '-', 'Masih Hidup'),
(8, '111', '981', 'a', 'KK', 'LK', 'ja', '2017-10-12', 'ISLAM', 'YA', 'SD/Sederajat', 'sa', 'K', '-', 'Masih Hidup'),
(9, '111', 'aaa', 'aksd', 'ISTRI', 'P', 'aj', '2019-01-28', 'ISLAM', 'TIDAK', 'SMP/Sederajat', 'A', 'K', '-', 'Masih Hidup'),
(10, '888', '89', 'aka', 'KK', 'LK', 'aa', '1990-06-21', 'ISLAM', 'YA', 'SD/Sederajat', 'aa', 'BK', '-', 'Masih Hidup'),
(11, '888', '871', 'ia', 'ISTRI', 'P', 'sa', '2019-01-29', 'ISLAM', 'YA', 'SD/Sederajat', 'ua', 'K', '-', 'Masih Hidup');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_tempo`
--
...
--
-- Dumping data for table `tbl_tempo`
--

INSERT INTO `tbl_tempo` (`id`, `tanggal`, `bulan`, `tahun`, `tempo`) VALUES
(1, '10', '2', 2020, '0000-00-00');
...
('112', '212', 'A18', 'A', '1', '8', '250000', 'Isi'),
('113', '993737', 'A14', 'A', '1', '4', '250000', 'Isi'),
('114', '1111', 'B414', 'B', '4', '14', '170000', 'Isi'),
('115', '348973', 'A115', 'A', '1', '15', '250000', 'Kosong');
...
--
-- Indexes for table `tbl_tempo`
--
ALTER TABLE `tbl_tempo`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `tbl_keluarga_meninggal`
  MODIFY `id_meninggal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_keluarga_sejahtera`
--
ALTER TABLE `tbl_keluarga_sejahtera`
  MODIFY `id_sejahtera` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tbl_keluarga_status_dan_kb`
--
ALTER TABLE `tbl_keluarga_status_dan_kb`
  MODIFY `id_sdk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT for table `tbl_tempo`
--
ALTER TABLE `tbl_tempo`
...
CREATE DEFINER=`root`@`localhost` EVENT `tempo` ON SCHEDULE EVERY 1 MONTH STARTS '2019-01-31 13:16:00' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Tempo' DO UPDATE tbl_tempo SET tempo = month(tempo) + 1 WHERE id = 1$$
