...
Public Class CariKodeBooking
    ...
    Private Sub TextBox1_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox1.KeyPress
        If e.KeyChar = Chr(13) Then
            koneksi()
            CMD = New MySqlCommand("SELECT * FROM booking_unit JOIN tbl_unit ON tbl_unit.id_unit = booking_unit.kode_unit WHERE booking_unit.kode_booking = '" & TextBox1.Text & "' AND status = 'Pending'", CONN)
            DR = CMD.ExecuteReader
            DR.Read()
            If Not DR.HasRows Then
                MsgBox("Maaf Kode Booking Tidak Terdaftar Atau Sudah Kadaluarsa!", MsgBoxStyle.Critical, "Aplikasi SIAP")
            Else
                ...
                MasterPenduduk.Label62.Text = DR.Item("kode_booking")
