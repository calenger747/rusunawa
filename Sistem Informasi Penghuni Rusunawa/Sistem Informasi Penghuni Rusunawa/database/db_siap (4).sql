...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 02, 2019 at 08:41 AM
...
-- Events
--
CREATE EVENT `pembayaran` ON SCHEDULE EVERY 1 MONTH STARTS '2018-09-10 00:00:00' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'menunggak pembayaran' DO UPDATE tbl_pembayaran SET keterangan = 'MENUNGGAK' WHERE keterangan = 'BELUM BAYAR'$$

CREATE EVENT `tempo` ON SCHEDULE EVERY 1 MONTH STARTS '2019-01-31 13:16:00' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Tempo' DO UPDATE tbl_tempo SET tempo = month(tempo) + 1 WHERE id = 1$$
