...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2018 at 05:42 AM
...
(5, '3276102805140002', '8109', 'aaas', 'ANAK', 'LK', 'aa', '2010-11-19', 'ISLAM', 'YA', 'SD/Sederajat', 'Pelajar', 'BK', '-', 'Masih Hidup');
...
CREATE TABLE `tbl_unit` (
  ...
  `kamar` text NOT NULL,
  `harga` text NOT NULL,
  `status` enum('Isi','Kosong','Book') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('112', '212', 'A18', 'A', '1', '8', '250000', 'Kosong'),
('113', '993737', 'A14', 'A', '1', '4', '250000', 'Kosong');
...
--
ALTER TABLE `tbl_penduduk`
  MODIFY `id_pend` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
