...
Public Class KepalaKeluarga
    ...
    Sub tampilSeluruhData()
        koneksi()
        DA = New MySqlDataAdapter("SELECT tbl_penduduk.nik, tbl_penduduk.nama, tbl_penduduk.jenis_kelamin, tbl_penduduk.tmpt_lahir, tbl_penduduk.tgl_lahir, tbl_penduduk.status_kk, tbl_unit.unit FROM tbl_penduduk, tbl_unit, tbl_keluarga WHERE tbl_penduduk.id_kk = tbl_keluarga.id_kk AND tbl_keluarga.id_penghuni = tbl_unit.id_unit AND tbl_penduduk.status_kk = 'KK'", CONN)
        DS = New DataSet
        DA.Fill(DS)
