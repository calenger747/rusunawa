...
Public Class TransaksiIuran
    ...
    Private Sub TextBox2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox2.KeyPress
        If e.KeyChar = Chr(13) Then
            ...
            If Not DR.HasRows Then
                MsgBox("Id pelanggan tidak ditemukan !", MsgBoxStyle.Information, "Master Penduduk - Aplikasi SIAP")
                TextBox2.Clear()
                TextBox2.Focus()
                Exit Sub
            Else
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        If TextBox2.Text = "" Then
            MsgBox("Isikan Id pelanggan!", MsgBoxStyle.Information, "Transaksi Iuran Bulanan - Aplikasi SIAP")
            TextBox2.Focus()
            Exit Sub
        Else
            Try
                ...
                MsgBox("Transaksi Berhasil", MsgBoxStyle.Information, "Master Penduduk - Aplikasi SIAP")
                kosong()
